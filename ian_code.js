			...
			switch(user.ability)
				{
					case "Heal":
						if(ability_on) {
							document.getElementById("stat_ability").src = "http://i.imgur.com/appfBRr.gif"; //heal toggled
						}
						else {
					...
					case "Growth":
						if(ability_on) {
							document.getElementById("stat_ability").src = "http://i.imgur.com/gdqsGXM.gif"; //growth toggled
						}
						else {
					...
					case "Sweeping Attack":
						if(ability_on) {
							document.getElementById("stat_ability").src = "http://i.imgur.com/8Za5IFy.gif"; //sweeping attack toggled
						}
						else {
					...
					case "Snipe":
						if(ability_on) {
							document.getElementById("stat_ability").src = "http://i.imgur.com/1HTWiSS.gif"; //snipe toggled
						}
						else {
					...
					case "Regeneration":
						if(ability_on) {
							document.getElementById("stat_ability").src = "http://i.imgur.com/s5rrFIT.gif"; //regeneration toggled
						}
						else {
					...
					case "Disarm":
						if(ability_on) {
							document.getElementById("stat_ability").src = "http://i.imgur.com/6F4O91S.gif"; //disarm toggled
						}
						else {
